            ...
            <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
              ...
              <div className="text-center">
                ...
                <p className="mt-6 text-lg leading-8 text-gray-300">
                  Home-based yoga and pilates enthusiasts frequently struggle
                  with proper form, exposing themselves to injuries and stalling
                  their fitness progress.
                  <br />
                  <br />
                  Welcome to Equilibrio, your ultimate companion for mastering
                  the art of yoga and pilates. Our innovative web app
                  ...
                  the most out of your practice, avoid injuries, and achieve
